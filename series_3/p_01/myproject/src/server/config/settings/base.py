...
DATABASES = {
    'default': env.db("DATABASE_URL", default="postgres://dev:myproject_dev@localhost/myproject")
}
...
STATIC_ROOT = str(APP_DIR.path('server/staticfiles'))
...
MEDIA_ROOT = str(APP_DIR('server/media'))
